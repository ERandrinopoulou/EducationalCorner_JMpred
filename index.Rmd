...
In this webpage, we describe the steps a researcher needs to follow in order to obtain dynamic prediction using a joint model of longitudinal and survival data.
