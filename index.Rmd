...
First load the functions for calibration curves that are presented in the tab **Functions**.
...
We can now procceed with internal validation.
...
Finally, we need to obtain and present the results.
